...
class PerspTransDetector(nn.Module):
    ...
    def forward(self, imgs):
        ...
        for i in range(imgs.shape[1]):
            ...
            t = t.resize((480,270))
            t.save(os.path.expanduser(f'~/code/jupyter/dua/data/per/image-f{i}.png'))
        ...
        if visualize:
            plt.imsave(os.path.expanduser(f'~/code/jupyter/dua/data/per/map_result-per.png'), map_result[0,0].detach().cpu().numpy())
