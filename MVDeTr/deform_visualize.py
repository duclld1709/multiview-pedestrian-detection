...
if __name__ == '__main__':
    ...
    for cam in range(dataset.num_cam):
        ...
        world_img = kornia.geometry.transform.warp_perspective(world_img, dataset.world_from_img[[cam]], dataset.worldgrid_shape,
                                            align_corners=False)[0]
        world_mask = kornia.geometry.transform.warp_perspective(img_mask, dataset.world_from_img[[cam]], dataset.worldgrid_shape,
        ...
        img_mask_points1 = kornia.geometry.transform.warp_perspective(world_mask_points1, dataset.img_from_world[[cam]],
                                                   dataset.img_shape, align_corners=False).squeeze()
        img_mask_points2 = kornia.geometry.transform.warp_perspective(world_mask_points2, dataset.img_from_world[[cam]],
                                                   dataset.img_shape, align_corners=False).squeeze()
        img_mask_points_og = kornia.geometry.transform.warp_perspective(world_mask_points_og, dataset.img_from_world[[cam]],
                                                     dataset.img_shape, align_corners=False).squeeze()
