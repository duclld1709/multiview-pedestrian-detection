...
if __name__ == '__main__':
    ...
    for cam in range(dataset.num_cam):
        ...
        img_mask_conv1 = kornia.geometry.transform.warp_perspective(world_mask_conv1, dataset.img_from_world[[cam]], dataset.img_shape,
                                                 align_corners=False)[0, 0].bool().numpy()
        img_mask_conv2 = kornia.geometry.transform.warp_perspective(world_mask_conv2, dataset.img_from_world[[cam]], dataset.img_shape,
                                                 align_corners=False)[0, 0].bool().numpy()
